...
#ifndef HealthBeat_hpp
#define HealthBeat_hpp
...
class HealthBeat: public BeatProtocal
{
public:
    static std::shared_ptr<HealthBeat> create(){ return std::make_shared<HealthBeat>();}
